...
$("#myRecipes").on("click", function (event) {
  event.preventDefault();
  console.log(ingredientsforFB);
  console.log(recipenameforFB);
  console.log("recipelink" + recipeLinkforFB);
  console.log("imagelink " + imagelinkforFB);

  // Craeting array to save to FB
  var myRecipe = {
